...
GameData::Attribute.register({
  ...
  :description  => _INTL("1.25x evasion, applies magic coat for 1 turn, 5% chance to redirect moves")
})
...
GameData::Attribute.register({
  :id           => :PRODIGY,
  :name         => _INTL("Prodigy"),
  :description  => _INTL("3 turns after being hit by a Super-Effective move, gain a Resistence to the type of the move")
})

GameData::Attribute.register({
  :id           => :BIOWEAPON,
  :name         => _INTL("Bio-weapon"),
  :description  => _INTL("When getting hit by or using a contact move, 30% chance to poison opponent, where the posion worsens after 3 turns")
})
